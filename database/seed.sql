...
INSERT INTO cards (name, type, rarity, cost, description, faction)
  VALUES ('Seiya de Pegaso', 'knight', 'rare', 3, 'El caballero de bronce más determinado, protector de Athena.', 'Athena')
  RETURNING id INTO v_seiya;
INSERT INTO card_knights (card_id, attack, defense, health, cosmos, can_defend, defense_reduction)
  VALUES (v_seiya, 120, 90, 150, 3, TRUE, 0.5);
INSERT INTO card_abilities (card_id, name, type, description, conditions, effects) VALUES
  (v_seiya, 'Meteoros de Pegaso',         'activa', 'Ataque múltiple que golpea hasta 3 enemigos',       '{"cosmos_min":2}',                      '{"multi_target":3,"damage_reduction":0.7}'),
  (v_seiya, 'Determinación Inquebrantable','pasiva', 'Cuando la vida es menor al 30%, +50% de ataque', '{"health_percent_max":30}',             '{"attack_bonus_percent":50}');

-- Shiryu de Dragón
INSERT INTO cards (name, type, rarity, cost, description, faction)
  VALUES ('Shiryu de Dragón', 'knight', 'rare', 3, 'El caballero más defensivo, maestro del Rozan Shoryu Ha.', 'Athena')
  RETURNING id INTO v_shiryu;
INSERT INTO card_knights (card_id, attack, defense, health, cosmos, can_defend, defense_reduction)
  VALUES (v_shiryu, 100, 130, 180, 3, TRUE, 0.3);
INSERT INTO card_abilities (card_id, name, type, description, conditions, effects) VALUES
...
-- Hyoga de Cisne
INSERT INTO cards (name, type, rarity, cost, description, faction)
  VALUES ('Hyoga de Cisne', 'knight', 'rare', 3, 'Maestro del hielo, con ataques que congelan al enemigo.', 'Athena')
  RETURNING id INTO v_hyoga;
INSERT INTO card_knights (card_id, attack, defense, health, cosmos, can_defend, defense_reduction)
  VALUES (v_hyoga, 110, 100, 140, 3, TRUE, 0.5);
INSERT INTO card_abilities (card_id, name, type, description, conditions, effects) VALUES
...
-- Shun de Andrómeda
INSERT INTO cards (name, type, rarity, cost, description, faction)
  VALUES ('Shun de Andrómeda', 'knight', 'rare', 3, 'El más gentil de los caballeros, pero letal con sus cadenas.', 'Athena')
  RETURNING id INTO v_shun;
INSERT INTO card_knights (card_id, attack, defense, health, cosmos, can_defend, defense_reduction)
  VALUES (v_shun, 90, 110, 160, 4, TRUE, 0.4);
INSERT INTO card_abilities (card_id, name, type, description, conditions, effects) VALUES
...
-- Ikki de Fénix
INSERT INTO cards (name, type, rarity, cost, description, faction)
  VALUES ('Ikki de Fénix', 'knight', 'epic', 4, 'El caballero inmortal que renace de sus cenizas.', 'Athena')
  RETURNING id INTO v_ikki;
INSERT INTO card_knights (card_id, attack, defense, health, cosmos, can_defend, defense_reduction)
  VALUES (v_ikki, 140, 80, 120, 4, TRUE, 0.6);
INSERT INTO card_abilities (card_id, name, type, description, conditions, effects) VALUES
  (v_ikki, 'Ave Fénix',   'activa', 'Ataque que aumenta de poder según el daño recibido',        '{"cosmos_min":3}',       '{"damage_scaling_by_missing_health":2}'),
  (v_ikki, 'Renacimiento','pasiva', 'Al morir, revive con 50% de vida (una vez por batalla)',  '{"death_trigger":true}', '{"revive":true,"revive_health_percent":50,"once_per_battle":true}');

-- Jabu de Unicornio
INSERT INTO cards (name, type, rarity, cost, description, faction)
  VALUES ('Jabu de Unicornio', 'knight', 'common', 2, 'Caballero leal con un cuerno perforador.', 'Athena')
  RETURNING id INTO v_jabu;
INSERT INTO card_knights (card_id, attack, defense, health, cosmos, can_defend, defense_reduction)
  VALUES (v_jabu, 80, 70, 100, 2, TRUE, 0.5);
INSERT INTO card_abilities (card_id, name, type, description, conditions, effects) VALUES
  (v_jabu, 'Galope del Unicornio', 'activa', 'Ataque rápido con penetración', '{"cosmos_min":1}', '{"armor_pierce":30,"damage":60}');
...
INSERT INTO card_knights (card_id, attack, defense, health, cosmos, can_defend, defense_reduction)
  VALUES (v_geki, 100, 60, 120, 2, TRUE, 0.5);
INSERT INTO card_abilities (card_id, name, type, description, conditions, effects) VALUES
...
INSERT INTO card_knights (card_id, attack, defense, health, cosmos, can_defend, defense_reduction)
  VALUES (v_ban, 90, 50, 90, 2, TRUE, 0.5);
INSERT INTO card_abilities (card_id, name, type, description, conditions, effects) VALUES
  (v_ban, 'Garra del León', 'activa', 'Ataque que causa sangrado', '{"cosmos_min":1}', '{"status_effect":"bleeding","damage_per_turn":10,"duration":3}');

-- Nachi de Lobo
INSERT INTO cards (name, type, rarity, cost, description, faction)
  VALUES ('Nachi de Lobo', 'knight', 'common', 2, 'Caballero salvaje con instintos de caza.', 'Athena')
  RETURNING id INTO v_nachi;
INSERT INTO card_knights (card_id, attack, defense, health, cosmos, can_defend, defense_reduction)
  VALUES (v_nachi, 85, 55, 95, 2, TRUE, 0.5);
INSERT INTO card_abilities (card_id, name, type, description, conditions, effects) VALUES
  (v_nachi, 'Aullido del Lobo', 'activa', 'Intimida a todos los enemigos, reduciendo su ataque', '{"cosmos_min":2}', '{"intimidate_all":true,"attack_reduction":20,"duration":2}');
...
INSERT INTO card_knights (card_id, attack, defense, health, cosmos, can_defend, defense_reduction)
  VALUES (v_ichi, 70, 65, 110, 3, TRUE, 0.5);
INSERT INTO card_abilities (card_id, name, type, description, conditions, effects) VALUES
...
INSERT INTO card_knights (card_id, attack, defense, health, cosmos, can_defend, defense_reduction)
  VALUES (v_misty, 130, 110, 170, 4, TRUE, 0.4);
INSERT INTO card_abilities (card_id, name, type, description, conditions, effects) VALUES
...
INSERT INTO card_knights (card_id, attack, defense, health, cosmos, can_defend, defense_reduction)
  VALUES (v_moses, 150, 120, 200, 4, TRUE, 0.3);
INSERT INTO card_abilities (card_id, name, type, description, conditions, effects) VALUES
...
INSERT INTO card_knights (card_id, attack, defense, health, cosmos, can_defend, defense_reduction)
  VALUES (v_asterion, 140, 100, 160, 4, TRUE, 0.5);
INSERT INTO card_abilities (card_id, name, type, description, conditions, effects) VALUES
...
INSERT INTO card_knights (card_id, attack, defense, health, cosmos, can_defend, defense_reduction)
  VALUES (v_babel, 135, 95, 150, 4, TRUE, 0.5);
INSERT INTO card_abilities (card_id, name, type, description, conditions, effects) VALUES
...
INSERT INTO card_knights (card_id, attack, defense, health, cosmos, can_defend, defense_reduction)
  VALUES (v_dante, 160, 130, 180, 5, TRUE, 0.3);
INSERT INTO card_abilities (card_id, name, type, description, conditions, effects) VALUES
...
INSERT INTO card_knights (card_id, attack, defense, health, cosmos, can_defend, defense_reduction)
  VALUES (v_jamian, 125, 85, 140, 3, TRUE, 0.5);
INSERT INTO card_abilities (card_id, name, type, description, conditions, effects) VALUES
...
INSERT INTO card_knights (card_id, attack, defense, health, cosmos, can_defend, defense_reduction)
  VALUES (v_capella, 110, 150, 190, 4, TRUE, 0.2);
INSERT INTO card_abilities (card_id, name, type, description, conditions, effects) VALUES
...
INSERT INTO card_knights (card_id, attack, defense, health, cosmos, can_defend, defense_reduction)
  VALUES (v_algol, 145, 115, 165, 5, TRUE, 0.4);
INSERT INTO card_abilities (card_id, name, type, description, conditions, effects) VALUES
...
INSERT INTO card_knights (card_id, attack, defense, health, cosmos, can_defend, defense_reduction)
  VALUES (v_mu, 170, 140, 220, 7, TRUE, 0.2);
INSERT INTO card_abilities (card_id, name, type, description, conditions, effects) VALUES
...
INSERT INTO card_knights (card_id, attack, defense, health, cosmos, can_defend, defense_reduction)
  VALUES (v_aldebaran, 200, 180, 280, 6, TRUE, 0.1);
INSERT INTO card_abilities (card_id, name, type, description, conditions, effects) VALUES
...
INSERT INTO card_knights (card_id, attack, defense, health, cosmos, can_defend, defense_reduction)
  VALUES (v_saga, 190, 120, 200, 8, TRUE, 0.4);
INSERT INTO card_abilities (card_id, name, type, description, conditions, effects) VALUES
...
INSERT INTO card_knights (card_id, attack, defense, health, cosmos, can_defend, defense_reduction)
  VALUES (v_deathmasque, 160, 130, 190, 6, TRUE, 0.4);
INSERT INTO card_abilities (card_id, name, type, description, conditions, effects) VALUES
...
INSERT INTO card_knights (card_id, attack, defense, health, cosmos, can_defend, defense_reduction)
  VALUES (v_aiolia, 185, 125, 210, 7, TRUE, 0.3);
INSERT INTO card_abilities (card_id, name, type, description, conditions, effects) VALUES
...
INSERT INTO card_knights (card_id, attack, defense, health, cosmos, can_defend, defense_reduction)
  VALUES (v_shaka, 165, 160, 240, 8, TRUE, 0.2);
INSERT INTO card_abilities (card_id, name, type, description, conditions, effects) VALUES
...
INSERT INTO card_knights (card_id, attack, defense, health, cosmos, can_defend, defense_reduction)
  VALUES (v_dohko, 175, 145, 250, 7, TRUE, 0.3);
INSERT INTO card_abilities (card_id, name, type, description, conditions, effects) VALUES
...
INSERT INTO card_knights (card_id, attack, defense, health, cosmos, can_defend, defense_reduction)
  VALUES (v_milo, 180, 135, 200, 7, TRUE, 0.3);
INSERT INTO card_abilities (card_id, name, type, description, conditions, effects) VALUES
...
INSERT INTO card_knights (card_id, attack, defense, health, cosmos, can_defend, defense_reduction)
  VALUES (v_aiolos, 195, 140, 230, 8, TRUE, 0.3);
INSERT INTO card_abilities (card_id, name, type, description, conditions, effects) VALUES
...
INSERT INTO card_knights (card_id, attack, defense, health, cosmos, can_defend, defense_reduction)
  VALUES (v_shura, 190, 130, 205, 7, TRUE, 0.4);
INSERT INTO card_abilities (card_id, name, type, description, conditions, effects) VALUES
...
INSERT INTO card_knights (card_id, attack, defense, health, cosmos, can_defend, defense_reduction)
  VALUES (v_camus, 170, 150, 220, 7, TRUE, 0.3);
INSERT INTO card_abilities (card_id, name, type, description, conditions, effects) VALUES
...
INSERT INTO card_knights (card_id, attack, defense, health, cosmos, can_defend, defense_reduction)
  VALUES (v_afrodita, 165, 135, 195, 7, TRUE, 0.4);
INSERT INTO card_abilities (card_id, name, type, description, conditions, effects) VALUES
